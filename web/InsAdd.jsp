    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/AddInsServlet" method="post" id="myform"  name="myform" >
                    <table class="insert-tab" width="100%">
                        <tr>
                            <th>机构名称:</th>
                            <td>
                                <input class="common-text required" id="title"  name="ins_name" size="50" value=""  placeholder="例如:黑马程序员" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th>推荐系数:</th>
                        ...
                        <tr>
                            <th>机构概述:</th>
                            <td>
                                <textarea name="ins_description" class="common-textarea" id="description" cols="30" style="width: 98%;" rows="10" placeholder="请输入机构简介或概述..." ></textarea>
                            </td>
